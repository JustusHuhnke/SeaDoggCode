export interface ISocketServer {
     ...
     */
    nsps: { [namespace: string]: ISocketNamespace };

    /**
     * The default '/' Namespace
     */
    sockets: ISocketNamespace;
     ...
     * @return This Server
     */
    serveClient(v: boolean): ISocketServer;
     ...
     * return This Server
     */
    origins(v: string): ISocketServer;
     ...
     * @return This Server
     */
    attach(srv: any | number, opts?: IServerOptions): ISocketServer;

    /**
     * @see attach( srv, opts )
     * @see attach( port, opts )
     */
    listen(srv: any | number, opts?: IServerOptions): ISocketServer;
     ...
     * @return This Server
     */
    onconnection(socket: any): ISocketServer;
     ...
     */
    of(nsp: string): ISocketNamespace;
     ...
     */
    on(event: "connection" | "connect", listener: (socket: ISocket) => void): ISocketNamespace;
     ...
     * @return The default '/' Namespace
     */
    on(event: string, listener: () => void): ISocketNamespace;
     ...
     * @see to( room )
     */
    in(room: string): ISocketNamespace;
     ...
     * @return The default '/' Namespace
     */
    use(fn: (socket: ISocket, fn: (err?: any) => void) => void): ISocketNamespace;
     ...
     * @return The default '/' Namespace
     */
    emit(event: string, ...args: any[]): ISocketNamespace;
     ...
     * @return The default '/' Namespace
     */
    send(...args: any[]): ISocketNamespace;

    /**
     * @see send( ...args )
     */
    write(...args: any[]): ISocketNamespace;

    /**
     * Gets a list of clients
     * @return The default '/' Namespace
     */
    clients(...args: any[]): ISocketNamespace;

    /**
     * Sets the compress flag
     * @return The default '/' Namespace
     */
    compress(...args: any[]): ISocketNamespace;
}
 ...
 */
export interface ISocketNamespace extends NodeJS.EventEmitter {
     ...
     */
    sockets: { [id: string]: ISocket };

    /**
     * A dictionary of all the Sockets connected to this Namespace, where
     * the Socket ID is the key
     */
    connected: { [id: string]: ISocket };
     ...
     * @return This Namespace
     */
    on(event: "connection" | "connect", listener: (socket: ISocket) => void): this;
     ...
     * @return This Namespace
     */
    clients(fn: () => void): ISocketNamespace;
     ...
     * @return This Namespace
     */
    compress(compress: boolean): ISocketNamespace;
}
...
export interface ISocket extends NodeJS.EventEmitter {
     ...
     * @see emit( event, ...args )
     */
    send(...args: any[]): ISocket;

    /**
     * @see send( ...args )
     */
    write(...args: any[]): ISocket;
     ...
     * @return This Socket
     */
    join(name: string, fn?: (err?: any) => void): ISocket;
     ...
     */
    leave(name: string, fn?: () => void): ISocket;
     ...
     * @return This Socket
     */
    disconnect(close?: boolean): ISocket;
     ...
     * @return This Socket
     */
    compress(compress: boolean): ISocket;
}

/**
 * The export interface used when dealing with rooms etc
 */
export interface ISocketAdapter extends NodeJS.EventEmitter {
...
export interface ISocketClient {
     ...
     */
    nsps: { [nsp: string]: ISocket };
}

/**
 * A reference to the underlying engine.io Socket connection.
 */
export interface IEngineSocket extends NodeJS.EventEmitter {
    /**
